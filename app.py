...
def get_joke():
    jokes = [
        ...
        "Why don’t programmers trust recipes generated by AI? They keep saying, ‘Just one more iteration.’",
        ...
        "Why did the cake trust the AI chef? It followed the recipe step by step—no bugs involved."
    ]
